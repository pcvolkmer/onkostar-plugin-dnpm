...
public class VerweisVon {
  ...
  public int getData_form_id() {
    return this.data_form_id;
  }

  public String getData_catalogue_name() {
    return this.data_catalogue;
  }

  public String getData_catalogue_entry_name() {
    return this.data_catalogue_entry;
  }
  ...
  public String getVerbundenesFormular() {
    ...
    if (this.getDatumAsString() != null) {
      FName += " vom " + this.getDatumAsString();
    }
    return FName;
  }
  ...
  public void setData_catalogue_name(String data_catalogue_name) {
    this.data_catalogue = data_catalogue_name;
  }

  public void setData_catalogue_entry_name(String data_catalogue_entry) {
    this.data_catalogue_entry = data_catalogue_entry;
  }
