...
public interface StudienService {
  ...
  /**
   * Übergibt eine Liste mit Studien, deren (Kurz-)Beschreibung oder Studiennummer den übergebenen
   * Wert enthalten
   *
  ...
  /**
   * Übergibt eine Liste mit aktiven Studien, deren (Kurz-)Beschreibung oder Studiennummer den
   * übergebenen Wert enthalten
   *
   * @param query Wert der enthalten sein muss
