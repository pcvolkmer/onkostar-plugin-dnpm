...
public interface FormService {
   ...
   * Siehe auch: <a
   * href="https://github.com/CCC-MF/onkostar-plugin-forminfo/blob/master/src/main/java/de/ukw/ccc/onkostar/forminfo/services/FormInfoService.java">FormInfoService.java</a>
   *
  ...
  /**
   * Diese Methode übergibt die Prozedur-IDs von Unterformularen zu einem Formular Siehe auch: <a
   * href="https://github.com/CCC-MF/onkostar-plugin-forminfo/blob/master/src/main/java/de/ukw/ccc/onkostar/forminfo/services/FormInfoService.java">FormInfoService.java</a>
   *
