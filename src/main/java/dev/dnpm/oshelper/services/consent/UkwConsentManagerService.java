    ...
    consents.stream()
        ...
        .ifPresent(
            lastConsent -> {
              ...
              dnpmKlinikAnamnese.setValue(
                  "ConsentStatusEinwilligungDNPM", new Item("Einwilligung", status.getString()));
              dnpmKlinikAnamnese.setValue(
                  "ConsentDatumEinwilligungDNPM", new Item("DatumEinwilligung", date));
