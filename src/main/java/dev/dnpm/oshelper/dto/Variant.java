...
/**
 * Ein Auszug der Variante aus dem NGS-Bericht zur Übertragung an das Frontend zur Auswahl der
 * stützenden molekularen Alteration
 *
 * @since 0.2.0
 */
    ...
    if (ergebnis.getString().equals("P")) {
      return Optional.of(
          new Variant(
              ...
              null == pathogenitaetsklasse || pathogenitaetsklasse.getString().isBlank()
                  ? "-"
