...
public class AnalyzerUtils {
  ...
  /**
   * Prüft, ob in InputMap einen Eintrag mit key <code>key</code> und Typ <code>type</code> gefunden
   * wurde.
   *
   ...
   */
  public static boolean requiredValuePresent(
      final Map<String, Object> input, final String key, final Class<?> type) {
  ...
  /**
   * Übergibt ein Optional mit Wert, wenn in InputMap ein Eintrag mit key <code>key</code> und Typ
   * <code>type</code> gefunden wurde. Anderenfalls ein leeres Optional
   *
   * <p><b>Beispiel</b>
   *
   * <pre>
   ...
   */
  public static <T> Optional<T> getRequiredValue(
      final Map<String, Object> input, final String key, final Class<T> type) {
   ...
   */
  public static boolean requiredValueMatches(
      final Map<String, Object> input, final String key, final String regexp) {
    var value = input.get(key);
   ...
   */
  public static Optional<String> getRequiredValueMatching(
      final Map<String, Object> input, final String key, final String regexp) {
  ...
  public static boolean requiredValueIsId(final Map<String, Object> input, final String key) {
    return requiredValuePresent(input, key, Integer.class)
        && Integer.parseInt(input.get(key).toString()) > 0;
  }
