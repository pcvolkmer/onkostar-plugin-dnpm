...
class UkwConsentManagerServiceTest {
  ...
  @Test
  void testShouldSkipUpdateRelatedDnpmKlinikAnamneseFormIfNoConsentDateAvailable()
      throws Exception {
  ...
  @Test
  void testShouldSkipUpdateRelatedDnpmKlinikAnamneseFormIfNoConsentValueAvailable()
      throws Exception {
    ...
    consentSubForm.setValue(
        "datum", new Item("datum", Date.from(Instant.parse("2023-04-03T12:00:00Z"))));
  ...
  void testShouldUpdateRelatedDnpmKlinikAnamneseFormOnFormSave() throws Exception {
    ...
    assertThat(savedForm.getValue("ConsentStatusEinwilligungDNPM").getString())
        .isEqualTo("accepted");
    assertThat(savedForm.getValue("ConsentDatumEinwilligungDNPM").getDate())
        .isEqualTo("2023-04-03T12:00:00Z");
  }
}
