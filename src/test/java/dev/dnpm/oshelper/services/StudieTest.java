...
class StudieTest {
  ...
  void shouldDetectStudieWithNctNumber() {
    var studie = new Studie("Kat 1", 1, null, "Nct-12345678", "Teststudie 1", "Teststudie 1", true);
  ...
  void shouldDetectStudieWithEudraCtNumber() {
    var studie =
        new Studie("Kat 1", 1, null, "2023-012345-12", "Teststudie 1", "Teststudie 1", true);
  ...
  void shouldReturnStudieWithUnknownNumberScheme() {
    var studie = new Studie("Kat 1", 1, "teststudie1", null, "Teststudie 1", "Teststudie 1", true);
