...
class DefaultSystemtherapieServiceTest {
  ...
  private static Set<Map.Entry<String, Class<OsSystemischeTherapieToProzedurwerteMapper>>>
      expectedMapperMappings() {
    return Map.ofEntries(
            ...
            Map.entry(
                ...
                OsSystemischeTherapieToProzedurwerteMapper.class))
        .entrySet();
  }
  ...
  void testShouldReturnSystemischeTherapienFromDiagnose() {
    ...
    assertThat(actual).isNotNull().isExactlyInstanceOf(ArrayList.class).hasSize(1);
  }
  ...
  void testShouldReturnListOfEcogStatusWithDate() {
    ...
    assertThat(actual).isNotNull().isExactlyInstanceOf(ArrayList.class).hasSize(2);
  }
}
