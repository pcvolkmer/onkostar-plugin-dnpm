...
class ProzedurToProzedurwerteMapperTest {
  ...
  void testShouldReturnSystemischeTherapienFromDiagnose() {
    ...
    procedure.setValue(
        "Beginn", new Item("Beginn", Date.from(Instant.parse("2023-01-01T00:00:00Z"))));
    ...
    assertThat(actual.get())
        .containsEntry("Beginn", Date.from(Instant.parse("2023-01-01T00:00:00Z")).toString());
    assertThat(actual.get())
        .containsEntry("Ende", Date.from(Instant.parse("2023-01-31T00:00:00Z")).toString());
